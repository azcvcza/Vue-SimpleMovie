		...
		<header class="nav">
			<div class="container">
				<div class="nav-left">
					...
					<a class="nav-item is-active">Shows</a>
					<a class="nav-item is-active">Music</a>
				</div>
				<div class="nav-right desktop">
					<span class="nav-item">
						<router-link to="/" class="title">VueFlix</router-link>
					</span>
				</div>
			</div>
		</header>
		<div class="container description-container">
			<div class="columns">
				<div class="column is-three-quarters">
					...
					<div class="links">
						<router-link :to="{path: '/' + $route.params.id + '/trailer'}" class="button play-button">
							Play
						...
						<a class="button is-link favorites-button" @click="addToFavorites(selectedMovie)">
							...
							<span :class="[{ 'hide': !selectedMovie.favorite }]">Remove from</span>&nbsp;favorites
